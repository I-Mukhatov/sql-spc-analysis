...
- **Detect anomalies** in product height measurements using dynamic control limits.
- **Identify operators** whose machines produce a higher-than-average number of out-of-control parts.
- **Visualize** the control process and operator performance through meaningful charts.
...
sql-spc-analysis/ ├── notebook.ipynb # Full analysis in SQL + Python ├── datalab_export_alerts.csv # Alerts dataset with control limits ├── datalab_export_stats.csv # Summary stats per operator ├── README.md # Project overview and findings
